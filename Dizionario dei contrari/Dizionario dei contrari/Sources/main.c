...
#include <stdio.h>
#include <string.h>
#include "../Headers/softwarePresenter.h"
...
void researchWord(int);
void giveOppositePhrase(int);
int takeWordIndex(char *);
...
int main(int argc, const char * argv[]) {
    ...
    doPresentation("Dizionario dei contrari", "Ricercare significato e contrario di una parola", "trovare il contrario di una frase");
...
// trovare altra soluzione per grandezza struct
void researchWord(int struct_lenght){
...
void giveOppositePhrase(int struct_lenght){
